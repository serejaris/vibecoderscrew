...
export function Features() {
  return (
    <section className="max-w-[1200px] mx-auto px-6 pb-24" id="features">
      ...
      <FadeUp delay={0.1}><p className="text-center text-slate-500 dark:text-slate-400 text-lg mb-16 font-space">Built for durable, inspectable AI workflows</p></FadeUp>
...
export function HowItWorks() {
  const steps = [
    { n: '1', title: 'Clone & install', code: 'git clone https://github.com/serejaris/vibecoderscrew.git\ncd vibecoderscrew && pip install -e .' },
    { n: '2', title: 'Start', code: 'vibecoderscrew gateway', note: 'The local dashboard opens at localhost:5476. Run vibecoderscrew doctor to verify the setup.' },
    { n: '3', title: 'Connect', note: 'Open the local dashboard or configure an optional channel integration from Settings.' },
  ];
  return (
    <section className="max-w-[800px] mx-auto px-6 pt-24 pb-24" id="how-it-works">
      ...
      <FadeUp delay={0.1}><p className="text-center text-slate-500 dark:text-slate-400 text-lg mb-16 font-space">Prerequisites: Python 3.10+; Node.js 18+ only when rebuilding the dashboard</p></FadeUp>
  ...
  return (
    <section className="text-center px-6 pt-24 pb-16 bg-[radial-gradient(ellipse_60%_50%_at_50%_100%,rgba(245,158,11,0.06),transparent)]">
      <Parallax speed={-0.15}>
        ...
        <FadeUp delay={0.1}><p className="text-slate-500 dark:text-slate-400 text-lg mb-8">Start from source, keep your configuration local, and shape every workflow to your needs.</p></FadeUp>
        <FadeUp delay={0.2}>
          <a href="#how-it-works" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-[15px] font-semibold bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-[0_0_24px_rgba(245,158,11,0.35)] hover:-translate-y-0.5 transition-all no-underline font-space">Install from source</a>
        </FadeUp>
        <FadeUp delay={0.3}>
          <div className="flex gap-4 justify-center mt-6 text-sm">
            <a href="https://github.com/serejaris/vibecoderscrew" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">GitHub</a>
            <span className="text-slate-600">&middot;</span>
            <a href="https://github.com/serejaris/vibecoderscrew/discussions" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">Discussions</a>
            <span className="text-slate-600">&middot;</span>
            <a href="https://github.com/serejaris/vibecoderscrew/issues" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">Issues</a>
          </div>
        </FadeUp>
      </Parallax>
    </section>
  ...
  return (
    <footer className="text-center py-10 px-6 border-t border-amber-500/12 text-slate-500 text-xs">
      <div className="flex gap-6 justify-center mb-3">
        {[['https://github.com/serejaris/vibecoderscrew', 'Source'], ['https://github.com/serejaris/vibecoderscrew/wiki', 'Wiki'], ['https://github.com/serejaris/vibecoderscrew/issues', 'Issues']].map(([href, label]) => (
      ...
      <p>VibecodersCrew — local-first AI workflows for people who build</p>
    </footer>
  );
}
