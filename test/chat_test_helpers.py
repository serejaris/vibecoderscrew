...
def _make_state(tmp_path, **kwargs):
    ...
    # Chat endpoint fixtures target ACP explicitly; Codex is the product
    # default and requires its own local sign-in probe in integration tests.
    sessions = MagicMock(count=0, configured_provider="acp")
