...
class TestKiroPrerequisiteHandlers:
    ...
    async def test_destructive_chat_routes_reject_before_mutating_history(
        ...
        # Provider dispatch is explicit; this route contract covers the ACP
        # destructive guard and must not use an implicit/unknown provider.
        sessions = MagicMock()
        sessions.configured_provider = "acp"
