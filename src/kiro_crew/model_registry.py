...
def _registry_window(canonical_or_id: str) -> int | None:
    ...
    window is a property of the model AS SERVED. The ACP view remains
    authoritative for kiro-specific aliases; claude_code is the fallback for
    ids only it lists. A canonical key/alias unique to one index resolves in
    that index.
    """
