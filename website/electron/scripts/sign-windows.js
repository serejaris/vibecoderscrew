...
// electron-builder signs VibecodersCrew.exe and Update.exe, packs them into the
...
// signed bytes back. See docs/windows-signing.md in the publishing runbook.
//
...
//   WINDOWS_SIGNING_PROFILE_ID       profile identifier, e.g. VibecodersCrewWindowsExe
...
exports.default = async function signWindows(configuration) {
  ...
  // ("VibecodersCrew Nightly") also carries a space, which is legal but awkward in a
