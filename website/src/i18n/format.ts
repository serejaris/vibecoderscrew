...
export function fmtDateNumeric(
  value: Date | string | number | null | undefined,
  options?: DateFieldOptions,
): string {
  return dateTime(value, { ...NUMERIC_DATE, ...options })
}

/** What `d.toLocaleTimeString()` rendered, second included — en `3:04:05 PM`. */
export function fmtTimeNumeric(
  value: Date | string | number | null | undefined,
  options?: DateFieldOptions,
): string {
  return dateTime(value, { ...NUMERIC_TIME, ...options })
}

/** What `d.toLocaleString()` rendered — en `7/30/2026, 3:04:05 PM`. */
export function fmtDateTimeNumeric(
  value: Date | string | number | null | undefined,
  options?: DateFieldOptions,
): string {
  return dateTime(value, { ...NUMERIC_DATE, ...NUMERIC_TIME, ...options })
}
