 ...
 * ACTIVE remote pane's tunnel connection state (host SSH expiry lives in the
 * title bar, not duplicated here).
 */
...
export default function InstanceTabBar({
  ...
  // gateway restart or a failed explicit reconnect (rendered with an error dot)
  ...
  // state. On the Local tab there is no active tunnel, so the cluster is hidden.
