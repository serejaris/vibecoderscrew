  ...
  return (
    <>
      ...
      <Card>
        ...
        {saveErr && <p className="text-danger text-[13px] mb-2">{saveErr}</p>}
        <div className="grid grid-cols-2 gap-x-6 gap-y-2 max-[600px]:grid-cols-1">
          <CfgSelect key={`provider-${rev}`} label={i18nT('pages.overview.kiroCrewCfgTab.provider')} path="agent.provider" value={cfg.agent.provider} options={['codex', 'acp']} labels={{ codex: i18nT('pages.overview.kiroCrewCfgTab.provider_codex'), acp: i18nT('pages.overview.kiroCrewCfgTab.provider_acp') }} hint={i18nT('pages.overview.kiroCrewCfgTab.provider_hint')} onSave={save} />
